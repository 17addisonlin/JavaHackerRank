...
- The second column contains the integer, expressed in exactly `3` digits. If the original input has less than three digits, you must pad the output's leading digits with zeroes.
